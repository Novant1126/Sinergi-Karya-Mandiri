...
// slide pertama
    $slide1 = $presentation->getActiveSlide(); // Pastikan slide aktif sudah ada
    ...
    if (isset($data)) {
        foreach ($data as $row) {
            ...
            // Menambahkan nama gedung dengan outline di atas gambar (tumpang tindih)
...
// slide kedua
    ...
    // Path gambar
    $imagePath2 = __DIR__ . '/img/2.png'; // Pastikan gambar ada di folder img
