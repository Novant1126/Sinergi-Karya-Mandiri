...
<body class="bg-light">
  ...
  <div class="container-fluid p-5">
    ...
    <div class="btn-group btn-sm mb-3" role="group" aria-label="Export Buttons">
      <!-- Tombol Export Excel -->
      <a href="../../export-excel/export.php?id_gedung=<?= $id_gedung ?>" target="_blank">
      ...
      <!-- <a href="../../export-excel/Export/export_pptx.html?id_gedung=<?= $id_gedung ?>"> -->
            ...
            $('#export-btn').click(function () {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = 'PPT/Audit.pptx'; // Redirect untuk download file
                    },
                    error: function () {
