      ...
      <table class="table table-sm table-bordered text-center">
        <thead class="table-info ">
          <tr>
            ...
            <th scope="col" class="py-2 px-2 small">Tanggal Selesai</th>
        ...
        <tbody>
          <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        //     $selesai = $row['selesai']; // Format Y-m-d H:i:s dari database
                            // Ubah ke format Y-m-d\TH:i untuk input datetime-local
                            ...
                            // echo "<td class='py-2 px-2 small'>" . $row['selesai'] . "</td>";
        ...
        <div class="modal-body">
          <form action="Proses/proses_gedung.php" method="POST">
            ...
            <div class="mb-3">
              ...
              <input class="form-control" type="date" id="modal-selesai" name="selesai">
            </div>
