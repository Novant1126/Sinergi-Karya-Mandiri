...
<head>
  ...
  @media (max-width: 576px) {
    ...
    td {
      white-space: nowrap;
      /* Hindari teks yang memanjang keluar */
    }

    .table-responsive {
      overflow-x: auto;
      /* Memungkinkan scroll horizontal jika dibutuhkan */
    }


    .modal-dialog {
      max-width: 90%;
      /* Kurangi ukuran modal */
      margin: 1rem auto;
      /* Tambahkan jarak di sisi atas dan bawah */
    }
    ...
    .modal-footer {
      padding: 1rem;
      /* Kurangi padding di bagian header dan footer */
    }
  }
  </style>
...
<body class="bg-light">
  <nav class="bg-blue-600 shadow-md">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <div class="flex items-center">
        <!-- Logo -->
        <div class="mr-6">
          <img src="../../IMG/Logo_Sinergi.png" alt="Your Company" class="h-8 w-auto" />
        </div>

        <!-- Menu Desktop -->
        <div class="hidden md:flex space-x-4">
          <a href="../Master/Master_Komponen.php" class="text-white hover:text-gray-200">Master Komponen</a>
  ...
  <div class="container-fluid p-5">
    ...
    <button type="button" class="btn btn-primary mb-3 btn-sm" data-bs-toggle="modal" data-bs-target="#tambahModal"><i
      ...
      <table class="table table-sm table-bordered text-center">
        <thead class="table-info ">
          <tr>
            ...
            <th scope="col" class="py-2 px-2 small">Foto Gedung</th>
          ...
          <?php
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                          ...
                          echo "<td class='py-2 px-2 text-center small'>";
                          if (!empty($row['foto_gedung'])) {
                              $fotoGedungPath = "Proses/uploads/foto_gedung/" . htmlspecialchars($row['foto_gedung']);
                              echo "<a href='$fotoGedungPath' target='_blank' style='text-decoration: none; color: blue;'>";
                              echo "Lihat Foto";
                              echo "</a>";
                          } else {
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Proses/proses_gedung.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="foto_gedung" class="form-label">Upload Foto Gedung</label>
            <input type="file" class="form-control" id="foto_gedung" name="foto_gedung" accept="image/*" capture="camera">
            <!-- capture="camera" akan membuka kamera pada perangkat jika didukung -->
          </div>
...
<div class="modal fade" id="ubahModal" tabindex="-1" aria-labelledby="ubahModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Proses/proses_gedung.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="foto_gedung" class="form-label">Upload Foto Gedung</label>
            <input type="file" class="form-control" id="modal-foto_gedung" name="foto_gedung" accept="image/*" >
          </div>
  ...
  function setModalData(rowData) {
    ...
    document.getElementById('modal-selesai').value = rowData.selesai.format('Y-m-d');
  }
